...
function WeatherInfo(){
    ...
    return(
        <div className="flex h-50 flex-col items-center justify-center bg-gray-800  ">
            <div className="w-100 bg-white/20 text-white placeholder-white/70 outline-none mx-auto text-center p-4 rounded-xl border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f]">
